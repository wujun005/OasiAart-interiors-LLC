    ...
    tabs: [
      {
        ...
        title: '家庭保洁',
        plans: [
          { title: '日常保洁 · 标准', desc: '客厅/卧室基础清洁 + 桌面收纳', price: 'AED 129 起', duration: '1.5 小时', icon: 'brush-o' },
          { title: '深度保洁 · 厨卫', desc: '重油区深度去渍 + 杀菌除螨', price: 'AED 199 起', duration: '3 小时', icon: 'fire' },
        ],
      },
      {
        name: 'appliance',
        title: '家电清洗',
        plans: [
          { title: '空调蒸汽洗', desc: '外机+内机杀菌清洗，保持风量', price: 'AED 159 起', duration: '90 分钟', icon: 'underway-o' },
          { title: '冰箱除味洗', desc: '拆洗密封胶圈，深层除菌除味', price: 'AED 129 起', duration: '60 分钟', icon: 'smile' },
        ],
      },
      {
        name: 'commercial',
        title: '商户保洁',
        plans: [
          { title: '店面开荒', desc: '硬化地面/橱窗清洁，开业前一次性焕新', price: 'AED 699 起', duration: '半天', icon: 'shop-o' },
          { title: '月度保洁', desc: '固定频次上门，保持环境稳定整洁', price: 'AED 1299 起', duration: '包月', icon: 'balance-list-o' },
        ],
      },
    ],
    contact: {
